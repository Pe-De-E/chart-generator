/**
 * Elevation Chart Theme System
 * Design tokens for consistent styling across the elevation chart
 */

import type { BackgroundType } from '../components/chartWorkflow/ElevationChartStep.vue'
 ...
 * Preset Themes
 */
export const ELEVATION_THEMES: ElevationTheme[] = [
  {
    id: 'dark',
    name: 'Dark',
 ...
 * Get a theme by ID
 */
export function getThemeById(id: string): ElevationTheme | undefined {
  return ELEVATION_THEMES.find(t => t.id === id)
}

/**
 * Get the default theme
 */
export function getDefaultTheme(): ElevationTheme {
  return ELEVATION_THEMES[0] // 'dark' is the default
}
